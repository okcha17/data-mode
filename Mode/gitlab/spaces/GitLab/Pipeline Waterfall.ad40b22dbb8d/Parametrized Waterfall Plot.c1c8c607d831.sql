...
close_date:
  type: select
  label: "Pipeline Change Close Range"
  default: quarter
  options: [day,week,month,quarter,year]

start_date:
  type: date
  label: "Pipeline Change from"
  description: 'Pipeline Change Date Range'
  default: '2018-12-16'

end_date:
  type: date
  label: 'Pipeline Change until (before)'
  description: 'Pipeline Change Date Range (End Date)'
  default: '2018-12-23'

metric_type:
  type: select
  label: "Pipeline Change Metric Type"
  options: [
    [ACV, ACV],
    [IACV, IACV],
    [Renewal ACV, Renewal ACV],
    [TCV, TCV]
  ]
  default: home
